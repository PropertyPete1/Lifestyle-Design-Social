...
Format: Return ONLY as JSON: {"title": "...", "description": "..."}`,
        ...
        const versionA = Object.assign(Object.assign({}, responses[0]), { score: await scoreCaptionVersion(responses[0], topHashtags, trendingKeywords, 'clickbait') });
        const versionB = Object.assign(Object.assign({}, responses[1]), { score: await scoreCaptionVersion(responses[1], topHashtags, trendingKeywords, 'informational') });
        const versionC = Object.assign(Object.assign({}, responses[2]), { score: await scoreCaptionVersion(responses[2], topHashtags, trendingKeywords, 'emotional') });
        ...
        return {
            versionA: Object.assign(Object.assign({}, fallbackVersion), { type: 'clickbait' }),
            versionB: Object.assign(Object.assign({}, fallbackVersion), { type: 'informational' }),
            versionC: Object.assign(Object.assign({}, fallbackVersion), { type: 'emotional' })
        };
    }
}
/**
