...
const initializeDatabase = async (): Promise<void> => {
  try {
    ...
    // Captions table for caption management
    await pool.query(`
    ...
    // Hashtags table for hashtag management
    await pool.query(`
    ...
    // Engagement insights table for dynamic posting times
    await pool.query(`
    ...
    // Posting schedule table for dynamic scheduling
    await pool.query(`
