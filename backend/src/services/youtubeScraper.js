    ...
    async fetchChannelVideos() {
        ...
        try {
            ...
            while (totalFetched < 200) { // Limit to 200 videos for analysis
                ...
                const videoDetailsResponse = await axios_1.default.get(`https://www.googleapis.com/youtube/v3/videos?part=snippet,statistics&id=${videoIds.join(',')}&key=${this.apiKey}`);
                // Process video data
